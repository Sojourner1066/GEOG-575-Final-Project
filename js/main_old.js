...
function getConcertInfo(filter_keyword, filter_event_type, eventDate, genreID=(Object.values(genre_dict)), map){
...
dateInput.addEventListener('change', function(selectedDate) {
    getConcertInfo(filter_keyword='', filter_event_type=null, eventDate=selectedDate.target.value, genreID=(Object.values(genre_dict)), map);
});
